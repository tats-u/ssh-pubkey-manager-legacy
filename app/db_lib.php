...
function AddOneKey($dbServer, $dbUser, $dbPass, $dbName, $userName, $keyData) {
    ...
    if(!array_key_exists("name", $keyData) || !array_key_exists("type") || !array_key_exists("content") || !array_key_exists("comment")) return ["succeeded" => false, "message" => "公開鍵を登録するのに必要なデータのいずれかが不足しています"];
